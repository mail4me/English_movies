...
st.title(TITLE)
st.write('Приложение предсказыает уровень английского для фильмов и сериалов на английском языке на основе машинного обучения. Но нужен файл с субтитрами. Уровень сложности по сертификации CEFR может быть A1, A2, B1, B2, C1, C2.')
